					...
					if (myFile.is_open()) {
							...
							myFile << "\n";
								for (int x = 0 ; x <= CartNum; x++) {
										...
										myFile << "\t\t>> Change:      PHP " << cashtender - totalPrice << endl << endl;
...
void TotalPriceChecker (int CartNumCont) {
	...
	while (true) {
        ...
        if (cin.fail()) {
			...
			cout << "\t>> Your change is: PHP " << cashtender - totalPrice << endl << endl;
			cout << "\tThank you for shopping at GUNPLA Store.\n\n\n";
			cout << "\n\t* Here is your receipt. *\n\n";
			cout << "\t\tRECEIPT #00" << receiptHold << endl;				
			cout << "\t\t==========================================\n";
			cout << "\t\t      G U N P L A F I N D  S T O R E \n"; 
			cout << "\t\t          The Gundam Place Store\n";
			cout << "\t\t==========================================\n\n";
			...
			cout << "\t\t>> Change:      PHP " << cashtender - totalPrice << endl << endl;
